...
public class Main {
    public static void main(String[] args) {
        ...
        SubTask subtask = new SubTask("Мыть машину", "Налить воду в ведро ", 1, TaskStatus.NEW, LocalDateTime.of(2002, 1, 1, 1, 15, 1), Duration.ofMinutes(30));
        ...
        SubTask subtask3 = new SubTask("Оплатить учебу", "Старательно учить!!", 2, TaskStatus.NEW, LocalDateTime.of(2002, 1, 1, 1, 15, 1), Duration.ofMinutes(30));
        Task task1 = new Task("Задача", "Решить", TaskStatus.NEW, LocalDateTime.of(2001, 1, 1, 1, 15, 1), Duration.ofMinutes(30));
