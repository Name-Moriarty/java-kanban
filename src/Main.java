...
public class Main {
    public static void main(String[] args) {
        ...
        SubTask subtask2 = new SubTask("Протереть машину на сухо", "Взять специальную тряпку", 1, TaskStatus.NEW);
        SubTask subtask3 = new SubTask("Оплатить учебу", "Старательно учить!!", 2, TaskStatus.NEW);
        Task task1 = new Task("Задача", "Решить", TaskStatus.NEW);
